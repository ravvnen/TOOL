...
public sealed record SeedDto
{
    ...
    public required string EventType { get; init; } // "im.proposal.v1"

    [JsonPropertyName("ns")]
    public required string Ns { get; init; } // "ravvnen.consulting"

    [JsonPropertyName("sha")]
    public required string Sha { get; init; } // "seed-test-item-v1"

    [JsonPropertyName("ci")]
    public required string Ci { get; init; } // "n/a"

    [JsonPropertyName("emitted_at")]
    public required DateTimeOffset EmittedAt { get; init; } // "2025-09-17T10:30:00Z"

    [JsonPropertyName("item_id")]
    public required string ItemId { get; init; } // "api.auth"

    [JsonPropertyName("title")]
    public required string Title { get; init; } // "API Authentication Standard"

    [JsonPropertyName("content")]
    public required string Content { get; init; } // "All API endpoints MUST use OAuth2 with bearer tokens.\nReject anonymous requests with HTTP 401."

    [JsonPropertyName("labels")]
    public required List<string> Labels { get; init; } // ["security", "api", "standard"]
...
public sealed record SourceInfo
{
    ...
    public required string Kind { get; init; } // "seeded" | "gh-webhook"

    [JsonPropertyName("repo_url")]
    public required string RepoUrl { get; init; } // "github.com/ravvnen/test-repo"

    [JsonPropertyName("ref")]
    public required string Ref { get; init; } // "main"

    [JsonPropertyName("path")]
    public required string Path { get; init; } // "/test/items/test-item.yaml"

    [JsonPropertyName("blob_sha")]
    public required string BlobSha { get; init; } // "abc123def456789"
